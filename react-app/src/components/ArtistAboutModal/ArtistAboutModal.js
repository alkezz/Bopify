...
const ArtistAboutModal = ({ artistBio, artistImg }) => {
    ...
    return (
        <div className='artist-biography-container' style={{ marginLeft: "40px" }}>
            ...
            <div onClick={handleOpen} className='artist-image-bio' style={{ borderRadius: "10px", backgroundSize: "1000px 550px", display: "flex", alignItems: "flex-end", color: "white", marginRight: "500px", fontSize: "18px", cursor: "pointer", backgroundImage: `url(${artistImg})`, height: "550px", backgroundRepeat: "no-repeat" }}>
